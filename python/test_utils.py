...
def BasicBandpass(filter='g', wavelength_step=1.):
    ...
    """
    bandpass = GenerateTemplate.load_bandpass(filter=filter, wavelength_step=wavelength_step,
...
class BasicGenerateTemplate(GenerateTemplate):
    ...
    def __init__(self, size=None, n_step=3, filter='g', exposure_time=30.,
        ...
        bandpass_init = BasicBandpass(filter=filter, wavelength_step=wavelength_step)
...
class BasicBuildDcrCoadd(BuildDcrCoadd):
    ...
    def __init__(self, filter='g', n_step=3, exposures=None):
        ...
        bandpass_init = BasicBandpass(filter=filter, wavelength_step=None)
        wavelength_step = (bandpass_init.wavelen_max - bandpass_init.wavelen_min) / n_step
        self.bandpass = BasicBandpass(filter=filter, wavelength_step=wavelength_step)
        self.n_step = n_step
...
class DcrCoaddTestBase:
    ...
    def setUp(self):
        ...
        self.dcrTemplate = BasicGenerateTemplate(size=size, filter=filter,
