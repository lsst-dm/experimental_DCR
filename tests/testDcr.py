...
class DCRTestCase(lsst.utils.tests.TestCase):
    ...
    def test_dcr_values(self):
        ...
        dcr_ref_vals = [(1.993806455667547, 1.6557373313591934),
                        (1.6557373313591934, 1.3430004302128062),
                        (1.3430004302128062, 1.0530839939487031),
                        (1.0530839939487031, 0.78378504676884375),
                        (0.78378504676884375, 0.53316423706042881),
                        (0.53316423706042881, 0.29950831367085751),
                        (0.29950831367085751, 0.081298775758445518),
                        (0.081298775758445518, -0.12281445337411216),
                        (-0.12281445337411216, -0.31403523964151242),
                        (-0.31403523964151242, -0.49344006586932754),
                        (-0.49344006586932754, -0.66199405778728948),
                        (-0.66199405778728948, -0.82056468012219985),
                        (-0.82056468012219985, -0.96993348610925834),
                        (-0.96993348610925834, -1.1108062335094022),
                        (-1.1108062335094022, -1.204706487955256),
                        ]
        bp = self.bandpass
