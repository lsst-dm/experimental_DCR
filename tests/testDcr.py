...
class DCRTestCase(lsst.utils.tests.TestCase):
    ...
    def test_dcr_values(self):
        ...
        dcr_ref_vals = [(1.958781639086969, 1.6207125147786157),
                        (1.6207125147786157, 1.3079756136322285),
                        (1.3079756136322285, 1.0180591773681253),
                        (1.0180591773681253, 0.74876023018826598),
                        (0.74876023018826598, 0.49813942047985099),
                        (0.49813942047985099, 0.26448349709027968),
                        (0.26448349709027968, 0.046273959177867689),
                        (0.046273959177867689, -0.15783926995468997),
                        (-0.15783926995468997, -0.34906005622209024),
                        (-0.34906005622209024, -0.52846488244990542),
                        (-0.52846488244990542, -0.69701887436786725),
                        (-0.69701887436786725, -0.85558949670277773),
                        (-0.85558949670277773, -1.0049583026898361),
                        (-1.0049583026898361, -1.14583105008998),
                        (-1.14583105008998, -1.239731304535834),
                        ]
        bp = self.bandpass
